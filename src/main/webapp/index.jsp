...
<h1 style = "text-align:center">FARMatrix</h1>
<div>

<button>Home</button>&nbsp; &nbsp; &nbsp; &nbsp;
&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
<button id="myButton" class="float-left submit-button" >Farmer</button>
&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
<script type="text/javascript">document.getElementById("myButton").onclick = function () {
        location.href = "login.jsp";
    };
</script>
<button id="myButton1" class="float-left submit-button" >Customer</button>
&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
<script type="text/javascript">document.getElementById("myButton1").onclick = function () {
        location.href = "login.jsp";
    };
</script>
<button id="myButton2" class="float-left submit-button" >Dealer</button>
<script type="text/javascript">document.getElementById("myButton2").onclick = function () {
        location.href = "login.jsp";
    };
</script>
...
<br>
<img src= "images/Home.jpg" width ="1000" height="550"><br>
